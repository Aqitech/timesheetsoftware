				...
				<form action="{{ route('update_user', ['id' => $user->id]) }}" method="post">
					...
					<div class="row g-3 mt-3">
						<div class="col-md-6">
	                        ...
	                        <input type="text" class="form-control timepicker" name="start_time" value="{{ $user->start_time }}">
						...
						<div class="col-md-6">
	                        ...
	                        <input type="text" class="form-control timepicker" name="end_time" value="{{ $user->end_time }}">
